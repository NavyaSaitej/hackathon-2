...
const i18n = {
  ...
  Hindi: {
    heroSubtitle:
      'किसी भी YouTube वीडियो को इंटरैक्टिव क्विज़ फ्लैशकार्ड में बदलें — AI द्वारा संचालित।',
    demoBtn: 'डेमो',
  ...
  Telugu: {
    heroSubtitle:
      'ఏదైనా YouTube వీడియోను ఇంటరాక్టివ్ క్విజ్ ఫ్లాష్‌కార్డ్‌లుగా మార్చండి — AI ద్వారా శక్తిని పొందుతుంది.',
    demoBtn: 'డెమో',
